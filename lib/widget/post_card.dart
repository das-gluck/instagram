...
import 'package:instagram_clone/widget/like_annimation.dart';
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  padding: const EdgeInsets.symmetric(vertical: 4),
                  child: Text( DateFormat().add_yMMMd().format(widget.snap['datePublished'].toDate(),) , style: const TextStyle(fontSize: 16, color: secondaryColor),),
                ),
              ],
            ),
          ),
